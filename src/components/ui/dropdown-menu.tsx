...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("-mx-1.5 my-1.5 bg-border/50 h-px", className)}
      {...props}
    />
  );
}
