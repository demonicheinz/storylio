...
const backgroundPresets = {
  home: {
    ...
    interactive: true,
    opacity: "opacity-100",
    mask: "[mask-image:linear-gradient(to_bottom,black_0%,black_78%,transparent_100%)]",
    minRadius: 1.1,
    maxRadius: 2.8,
    lineOpacity: 0.22,
  ...
  about: {
    ...
    connectThreshold: 135,
    interactive: true,
    opacity: "opacity-85",
    mask: "[mask-image:linear-gradient(to_bottom,black,transparent_92%)]",
    minRadius: 0.95,
    maxRadius: 2.5,
    lineOpacity: 0.18,
    mouseLineOpacity: 0.36,
  },
  projects: {
    count: 38,
    speed: 0.18,
    ...
    interactive: true,
    opacity: "opacity-90",
    mask: "[mask-image:radial-gradient(circle_at_top,black,transparent_82%)]",
    minRadius: 1,
    maxRadius: 2.6,
    lineOpacity: 0.2,
  ...
  blog: {
    ...
    interactive: false,
    opacity: "opacity-80",
    mask: "[mask-image:linear-gradient(to_bottom,black,transparent_88%)]",
    minRadius: 0.9,
    maxRadius: 2.3,
    lineOpacity: 0.17,
  ...
  gallery: {
    ...
    interactive: true,
    opacity: "opacity-85",
    mask: "[mask-image:radial-gradient(circle_at_center,black,transparent_80%)]",
    minRadius: 1,
    maxRadius: 2.7,
    lineOpacity: 0.2,
    mouseLineOpacity: 0.38,
